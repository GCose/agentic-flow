...
const LeadDetailPage = () => {
  ...
  const meta = lead
    ? {
        ...
        icon: ClientPageMeta.leadDetailPage.icon,
      }
    ...
    <DashboardLayout role="client" meta={meta}>
      <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-transparent backdrop-blur-xs px-4 sm:px-6 border-slate-800">
        ...
        <div className="flex items-center gap-2">
          <h2 className="text-xl font-semibold">{lead.company} Lead Details</h2>
      ...
      <div className="flex-1 space-y-6 p-8 pt-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2 border border-slate-800 bg-transparent ">
            <CardHeader>
