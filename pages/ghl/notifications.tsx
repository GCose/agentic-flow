...
export default function GHLNotificationsPage() {
  ...
  return (
    <DashboardLayout meta={{ title: "GHL Notifications" }} role="ghl_admin">
      <DashboardHeader title="GHL Notifications" />
        ...
        <Card className="border-none bg-transparent">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              These are notifications relevant to GHL operations.
            </p>
          </CardHeader>
          <CardContent>
            {loading ? (
